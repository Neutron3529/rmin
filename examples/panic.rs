...
#[no_mangle]
pub extern "C" fn test(a: SEXP, b: SEXP) -> Owned {
    ...
    if c_data[0] < 1. && c_data[0] > -1. {
        panic!("Sorry, but the function panic!\nNote: There is no need to change the return type since actually you don't know whether the program could panic.")
    }
    c
}
